                ...
                <div class="flex-1  px-8 py-6">
                    <div class="modal-wrapper space-y-2 relative pb-12 ">
                        <div class="content p-2 shadow-md bg-white rounded-sm">
                            <h1 class="uppercase font-bold text-sm">KATA</h1>
                        </div>
                        ...
                        <div class="modal   bg-white mx-auto z-50 shadow-md  inset-x-0 top-0 w-full h-max  ">
                            ...
                            {{-- form --}}
                            <form action="/setting/wards" class="space-y-4 px-6 py-5" method="POST">
                                @csrf
                                <div class="space-y-2">
                                    <label for="ward" class="block ">Jina la Kata</label>
                                    <input type="text" id="ward" class="ward w-full" name="name">
                                </div>
                                <button type="submit"
                                ...
                                <tbody class="divide-y bg-white border-b-2 border-gray-300">
                                    @forelse ($wards as  $ward)
                                        <tr class="whitespace-nowrap align-baseline text-center">
                                            <td class="border px-6 py-2 text-sm w-8">{{ $ward->id }}</td>
                                            <td class="border px-6 py-2 text-sm ">{{ $ward->name }}</td>
