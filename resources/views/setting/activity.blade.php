            ...
            <div class="flex-1  px-8 py-6">
                <div class="modal-wrapper space-y-2 relative pb-12 ">
                    <div class="content p-2 shadow-md bg-white rounded-sm">
                        <h1 class="uppercase font-bold text-sm">Shughuli za Vikundi</h1>
                    </div>
                    ...
                    <div class="form shadow-md px-8 py-4 bg-white ">
                        <div class="search flex justify-between">
                            ...
                            <form action="#" method="get" class="flex items-center   space-x-4">
                                <div>
                                    <input type="search" name="search" id="search" placeholder="Shughuli ya Kikundi">
                                </div>
                                <button type="submit"
                    ...
                    <div class="modal  bg-white mx-auto z-50 shadow-md  inset-x-0 top-0 w-full h-max  ">
                        ...
                        <form action="/activity" method="POST" class="space-y-4 px-6 py-5">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" id="activity" class="activity w-full" name="activity">
                            </div>
                        ...
                        <table class="w-full ">
                            <thead class="bg-gray-300 divide-y divide-gray-500">
                                <tr class="whitespace-nowrap">
                                    ...
                                    <th class="px-6 py-2 text-sm text-gray-600">Aina ya Shughuli </th>
                                ...
                                @if (count($activity) > 0)
                                    @forelse ($activity as $act)
                                        <tr class="whitespace-nowrap align-baseline text-center">
                                            <td class="border px-6 py-2 text-sm w-8">{{ $act->id }}</td>
                                            <td class="border px-6 py-2 text-sm ">{{ $act->name }}</td>
                                            <td class="border px-6 py-2 text-sm w-8">

                                                <a href="/wards" title="view" class="text-sky-500">
                                            ...
                                            <td class="border px-6 py-2 text-sm w-8 ">
                                                ...
                                                <a href="/wards" title="edit" class="text-red-500">
